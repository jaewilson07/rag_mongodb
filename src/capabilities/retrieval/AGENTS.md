# Retrieval Capability (src/capabilities/retrieval)

## Purpose

Vector store operations, embedding generation, and result formatting for the RAG query path. This is the "read side" of the data plane — ingestion writes, retrieval reads. Canonical import: `mdrag.retrieval` (redirects to `capabilities.retrieval`).
