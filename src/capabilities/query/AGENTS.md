# Query Capability (src/capabilities/query)

## Purpose

Grounded query execution: retrieve context, generate answers, verify citations, and store traces. This is the core RAG read path that the API and CLI both use. Canonical import: `mdrag.query` (redirects to `capabilities.query`).
